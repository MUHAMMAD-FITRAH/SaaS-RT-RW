...
export async function PATCH(req: NextRequest) {
  try {
    ...
    const { id, namaUsaha, pemilik, jenis, alamat, nomorHP, deskripsi, foto, isMarketplace } = body;
    ...
    if (isMarketplace !== undefined) updateData.isMarketplace = Boolean(isMarketplace);
